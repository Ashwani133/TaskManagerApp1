...
public class myWeek extends AppCompatActivity {
    TextView tv_myWeekTitle;
    ListView lv_myWeekTasks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_myWeekTitle = findViewById(R.id.tv_myWeekTitle);
        lv_myWeekTasks = findViewById(R.id.lv_myWeekTasks);

        CustomAdapterMytasks customAdapterMytasks = new CustomAdapterMytasks(getApplication(),mytasksId,mytasksSubject,mytasksDate
                ,mytasksTime);
        lv_myWeekTasks.setAdapter(customAdapterMytasks);

        lv_myWeekTasks.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {

                Intent intent = new Intent(myWeek.this,taskDetails.class);
