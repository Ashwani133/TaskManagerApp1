...
public class CustomAdapterFragmentMyDay extends BaseAdapter {
    ...
    public CustomAdapterFragmentMyDay(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                String[] mytasksTime){
