...
public class CustomAdapterMyAllTasks extends BaseAdapter {
    ...
    public CustomAdapterMyAllTasks(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                String[] mytasksTime){
