...
public class CustomAdapterTasksInProgress extends BaseAdapter {
    ...
    public CustomAdapterTasksInProgress(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                String[] mytasksTime){
