...
public class CustomAdapterTasksCompleted extends BaseAdapter {
    ...
    public CustomAdapterTasksCompleted(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                        String[] mytasksTime){
