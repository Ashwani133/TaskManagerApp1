...
public class CustomAdapterTaskPastDue extends BaseAdapter {
    ...
    public CustomAdapterTaskPastDue(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                        String[] mytasksTime){
