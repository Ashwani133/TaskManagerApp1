...
public class CustomAdapterFragmentMyWeek extends BaseAdapter {
    ...
    public CustomAdapterFragmentMyWeek(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                      String[] mytasksTime){
