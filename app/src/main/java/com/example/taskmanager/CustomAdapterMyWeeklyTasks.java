...
public class CustomAdapterMyWeeklyTasks extends BaseAdapter {
    ...
    public CustomAdapterMyWeeklyTasks(Context ctx,String[] mytasksId, String[] mytasksSubject, String[] mytasksDate,
                                String[] mytasksTime){
